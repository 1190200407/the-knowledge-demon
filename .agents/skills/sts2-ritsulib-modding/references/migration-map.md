...
本文件用于快速把 BaseLib 写法迁到 RitsuLib。优先配合 `.agents\RitsuLib-doc\Migrations\02 - BaseLib 至 RitsuLib\README.md` 和 `D:\My Projects\GodotProjects\STS2-RitsuLib-0.4.33` 使用。
...
迁移/取证时也应先读当前仓库自己的 agent / skill / 项目规则；仓库规则优先级高于本映射文件。
...
- `D:\My Projects\GodotProjects\STS2-RitsuLib-0.4.33\docs`
- `D:\My Projects\GodotProjects\STS2-RitsuLib-0.4.33\Keywords\ModKeywordRegistry.cs`
