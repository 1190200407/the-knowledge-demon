...
[RegisterPower]
public sealed class RelativityPower : KnowledgeDemonPowerModel, IKnowledgeDemonEventListener
{
    private static readonly LocString MaterializePrompt =
        new("cards", "KNOWLEDGE_DEMON_CARD_RELATIVITY.selectionScreenPrompt");
